...
const CardData: Card[] = [
    {
        id: 1,
        title: '지수의 velog',
        desc: '안녕하세요 처음 velog를 시작해보았는데요 아직은 많이 어색하네요. 그래도 많이많이 기록해보도록 하겠읍니다요 뿅',
        author: '신짓두',
    ...
    {
        id: 4,
        title: '원티드 월급복권 Day1 당첨!',
        desc: '원티드 월급복권 당첨됐습니당 감사합니다 원티드 !!!!!',
        author: '박진현',
    ...
    {
        id: 5,
        title: '아직도 PR 올리고 카톡으로 알리시나요?',
        desc: '이제 카톡으로 PR 확인해달라고 하지 않아도 됩니다. 자동으로 할거거든요.',
        author: 'Jun_Gyu',
